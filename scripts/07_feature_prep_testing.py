...
PATH_TO_LOGFILE = PATH_TO_DATA + 'status/hyperparameter_tuning_resnet_chunky_SVM.log'
feature_file = PATH_TO_DATA + 'processed/cv_datasets/resnet_feature_dataset_top277_max1000.npz' 
csv_file_path = PATH_TO_DATA + 'status/hyperparameter_tuning_resnet_chunky_SVM.csv'

#model_names = ["KNN", "Linear Classifier", "SVM"]
model_names = ['SVM']
...
def handle_results(csv_path, test, pred, method, model, params, reduction_time, training_time, neighbors=None, C=None, lr=None, epochs=None, losses=None, accuracies=None):
                ...
                for epochs in config['linear__epochs']:
                    for lr in config['linear__learning_rate']:
                        ...
                        handle_results(csv_file_path, y_test, y_pred_numpy, reducer_name, model_name, 
                                    ...
                                    lr=lr, epochs=epochs, accuracies=accuracies, losses=losses, C=None)
