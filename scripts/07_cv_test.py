'''
This script performs cross-validation testing of different classifiers (Logistic Regression, KNN) 
on extracted features. It includes feature reduction using PCA (512 principal components) and evaluates the models using 
...
for fm in FOUNDATIONAL_MODEL_NAMES:
    ...
    for dataset_name, (class_amount, sample_amounts) in DATASET_CONFIGS.items():
        ...
        for sample_amount in sample_amounts:
            ...
            # proceed = input(f'About to load features from {feature_file}... proceed? y/n ')
            # if proceed.lower() != 'y':
            #     sys.exit(0)
